...
const sections: TroubleshootSection[] = [
  ...
  },
  {
    ...
    steps: [
      'macOS: System Settings → Network → Firewall — allow Tobasco.',
      'Windows: Defender Firewall → Allow app — enable Tobasco for Private networks.',
  ...
  },
  {
    ...
    steps: [
      'Tobasco must be open on your desktop to accept connections.',
      'Try restarting Tobasco — the companion server starts on launch.',
